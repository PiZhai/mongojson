...
export type WorkspaceTransferTarget = 'json' | 'mongodb-json' | 'visualize'
...
export function readWorkspaceTransfer(target: WorkspaceTransferTarget, mode?: string): WorkspaceTransferPayload | null {

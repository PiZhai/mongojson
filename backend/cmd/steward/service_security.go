...
var runtimeSecurityEnvKeys = []string{
	"STEWARD_OWNER_MODE",
	"STEWARD_API_TIMEOUT",
	"STEWARD_ALLOW_REMOTE_MANAGEMENT",
	"STEWARD_RESTRICTED_SERVICE",
	"STEWARD_MANAGEMENT_AUTH_REQUIRED",
	"STEWARD_MANAGEMENT_AUTH_TOKEN",
	"STEWARD_MANAGEMENT_ALLOWED_ORIGINS",
	"STEWARD_MODEL_SETTINGS_KEY_RECOVERY",
	"STEWARD_RUNTIME_V2",
	"STEWARD_RUNTIME_R2",
	"STEWARD_RUNTIME_R3",
	"STEWARD_ORCHESTRATION_R4",
	"STEWARD_ORCHESTRATION_WORKERS",
	"STEWARD_ORCHESTRATION_REMOTE",
	"STEWARD_ORCHESTRATION_DELEGATION_TTL",
	"STEWARD_ORCHESTRATION_MESSAGE_LEASE",
	"STEWARD_REMOTE_EXECUTION_LEASE",
	"STEWARD_REMOTE_EXECUTION_TOOLS",
	"STEWARD_BROKER_URL",
	"STEWARD_BROKER_CLIENT_KEY",
	"STEWARD_BROKER_PUBLIC_KEY",
	"STEWARD_RUNTIME_ALLOWED_ROOTS",
	"STEWARD_RUNTIME_EXECUTABLES",
	"STEWARD_RUNTIME_WEB_ALLOWED_HOSTS",
	"STEWARD_RUNTIME_BROWSER_OPEN_ENABLED",
	"STEWARD_RUNTIME_PLANNER_PROVIDER",
	"STEWARD_RUNTIME_PLANNER_BASE_URL",
	"STEWARD_RUNTIME_PLANNER_MODEL",
	"STEWARD_RUNTIME_PLANNER_API_KEY",
	"STEWARD_RUNTIME_PLANNER_ALLOW_NO_API_KEY",
	"STEWARD_RUNTIME_PLANNER_TIMEOUT",
	"STEWARD_RUNTIME_PLANNER_MAX_DATA_LEVEL",
	"STEWARD_ORCHESTRATION_SIGNING_KEY",
	"STEWARD_ORCHESTRATION_VERIFY_KEY",
	"STEWARD_RUNTIME_INTERVAL",
	"STEWARD_RUNTIME_LIMIT",
	"STEWARD_RUNTIME_LEASE_TTL",
	"STEWARD_RUNTIME_EVIDENCE_MAX_BYTES",
	"STEWARD_RUNTIME_WATCHDOG_INTERVAL",
	"STEWARD_RUNTIME_WATCHDOG_LIMIT",
	"STEWARD_RUNTIME_INCLUDE_KNOWN_FOLDERS",
	"STEWARD_RUNTIME_USER_HOME",
	"STEWARD_AGENT_MAX_ROUNDS",
	"STEWARD_AGENT_MAX_TOOL_CALLS",
	"STEWARD_AGENT_MAX_DURATION",
	"STEWARD_AGENT_NO_PROGRESS_LIMIT",
	"STEWARD_AGENT_PROGRESS_DETAIL",
	"STEWARD_ACTIVITY_SAMPLE_INTERVAL",
	"STEWARD_AUTONOMY_LIMIT",
	"STEWARD_MODEL_DISPATCH_INTERVAL",
	"STEWARD_MODEL_DISPATCH_LIMIT",
	"STEWARD_NOTIFICATION_INTERVAL",
	"STEWARD_NOTIFICATION_LIMIT",
	"STEWARD_PROACTIVE_INTERVAL",
	"STEWARD_PROACTIVE_TOOLSMITH_INTERVAL",
	"STEWARD_PROACTIVE_DAILY_HOUR",
	"STEWARD_PROACTIVE_WEEKLY_DAY",
	"STEWARD_PROACTIVE_WEEKLY_HOUR",
	"STEWARD_CAPTURE_PROFILE",
	"STEWARD_PRESIDIO_URL",
	"STEWARD_PRESIDIO_LANGUAGE",
	"STEWARD_PRESIDIO_MIN_SCORE",
	"STEWARD_COMPANION_PIPE",
	"STEWARD_COMPANION_URL",
	"STEWARD_TOOL_ROOT",
	"STEWARD_API_BASE",
	"STEWARD_SYNC_REQUIRE_AUTH",
	"STEWARD_SYNC_ALLOW_INSECURE",
	"STEWARD_PAIRING_PRIVATE_KEY",
	"STEWARD_PAIRING_PUBLIC_KEY",
	"STEWARD_PAIRING_RECIPIENT_PUBLIC_KEY",
	"STEWARD_NTFY_URL",
	"STEWARD_NTFY_TOPIC",
	"STEWARD_NTFY_TOKEN",
	"STEWARD_SMTP_HOST",
	"STEWARD_SMTP_PORT",
	"STEWARD_SMTP_USERNAME",
	"STEWARD_SMTP_PASSWORD",
	"STEWARD_NOTIFICATION_EMAIL_FROM",
	"STEWARD_NOTIFICATION_EMAIL_TO",
}
...
func serviceExtraEnvFromServiceEnv(env map[string]string) map[string]string {
	...
	keys := append(append(append(append([]string{}, strictAdvisorEnvKeys...), autonomyRetryEnvKeys...), discoveryEnvKeys...), runtimeSecurityEnvKeys...)
